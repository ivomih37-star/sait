...
const KINDS = [
  {
    name: "Сливова",
    desc: "Из слив — самая популярная и узнаваемая болгарская ракия.",
  },
  {
    name: "Гроздова",
    desc: "Виноградная ракия, близкая родственница граппы и чачи.",
  },
  {
    name: "Кайсиева",
    desc: "Абрикосовая — мягкая, с выраженным фруктовым ароматом.",
  },
  {
    name: "Дюлева",
    desc: "Айвовая ракия — редкая, ценится за тонкий вкус.",
  },
];
      ...
      <main>
        ...
        <section id="o-rakii" className="section">
          <div className="container">
            ...
            <div className="cards">
              {KINDS.map((k) => (
                <article key={k.name} className="card">
                  <h3>{k.name}</h3>
                  <p>{k.desc}</p>
                </article>
              ))}
